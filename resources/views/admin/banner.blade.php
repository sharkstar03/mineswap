                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        @csrf
                                        <div class="image-input">
                                            <label for="image-upload" id="meta_image-label"><i
                                                    class="fas fa-upload"></i></label>
                                            <input type="file" name="form_thumbs" placeholder="Choose image"
                                                   id="meta_image">
                                            <img id="meta_image_preview_container" class="preview-image"
                                                 src="{{getFile(config('location.logo.path').'form_thumbs.png') ? : 0}}"
                                                 alt="preview image">
                                        </div>
                                        @error('form_thumbs')
                                        <span class="text-danger">{{$message}}</span>
