...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin', 'permission']], function () {
        ...
        /*=====Mining List=====*/
        Route::get('mining-lists', 'Admin\MiningListController@index')->name('mining.lists');
        Route::post('mining-lists', 'Admin\MiningListController@store')->name('mining.add');
        Route::put('mining-lists/{id}', 'Admin\MiningListController@update')->name('mining.update');

        Route::get('manage-plan', 'Admin\MiningListController@plans')->name('manage-plan');
        Route::get('manage-plan/create', 'Admin\MiningListController@planCreate')->name('manage-plan.create');
        Route::post('manage-plan/create', 'Admin\MiningListController@planStore')->name('manage-plan.store');
        Route::get('manage-plan/edit/{miningPlan}', 'Admin\MiningListController@planEdit')->name('manage-plan.edit');
        Route::patch('manage-plan/edit/{miningPlan}', 'Admin\MiningListController@planUpdate')->name('manage-plan.update');

        Route::get('/referral-commission', 'Admin\MiningListController@referralCommission')->name('referral-commission');
        Route::post('/referral-commission', 'Admin\MiningListController@referralCommissionStore')->name('referral-commission.store');


        /* ====== Investment Log =====*/
        Route::get('/investment/running', 'Admin\LogController@investmentRunning')->name('investment.running');
        Route::get('/investment/complete', 'Admin\LogController@investmentComplete')->name('investment.complete');
        Route::get('/investment/search', 'Admin\LogController@investmentSearch')->name('investment.search');
        ...
        Route::get('/user/wallet/{id}', 'Admin\UsersController@wallet')->name('user.wallet');
        Route::put('/user/wallet/{id}', 'Admin\UsersController@walletUpdate')->name('user.walletUpdate');
...
Route::middleware('Maintenance')->group(function () {
    ...
    Route::group(['middleware' => ['auth'], 'prefix' => 'user', 'as' => 'user.'], function () {
        ...
        Route::middleware('userCheck')->group(function () {
            ...
            Route::middleware('kyc')->group(function () {
                ...
                Route::post('plan-order', 'User\HomeController@planOrder')->name('plan-order');
                Route::get('plan/log', 'User\HomeController@planLog')->name('plan-log');

                Route::get('/wallet', 'User\HomeController@myWallets')->name('wallet');
                Route::put('/wallet', 'User\HomeController@myWalletsUpdate')->name('myWalletsUpdate');
    ...
    Route::post('/ajaxPlansByCoin', 'FrontendController@ajaxPlansByCoin')->name('ajaxPlansByCoin');
