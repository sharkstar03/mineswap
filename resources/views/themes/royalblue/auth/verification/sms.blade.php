            ...
            <div class="row align-items-center gy-5 justify-content-between">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="account-form-wrapper">
                        ...
                        <form class="contact-form row gy-4" action="{{route('user.smsVerify')}}"  method="post">
                            @csrf
                        ...
                        <span class="subtitle mt-4">@lang("Didn\'t get Code? Click to")</span>
                        <a href="{{route('user.resendCode')}}?type=mobile"  class="create-account text--base ms-2">@lang("Resend code")</a>
                        @error('resend')
